...
def create_default_campus_config(config_path: str):
    ...
    default_config = {
        ...
        "other_params": {
            "topic": "南方某大学物理学院，电子科学与技术专业，张杰（四川人，高考复读，小镇做题家）和苏月（大连人，祖籍南方，温婉知性，大部分时间安静有文艺气息，偶尔调皮耍嘴皮子）。大四考研教室只剩三人——张杰、苏月、陈北（防城港人）。考研期间的奶黄包、螺蛳粉、考研兔子（苏月养在教室里，后来被老师发现送人，张杰每天第一个到教室铲屎、抱怨"高考复习都没这么辛苦过"）、猫屋咖啡（她叫'猫南北'，他叫'大汪'）。张杰考上成都读研，苏月落榜。第二年苏月二战，来成都找他，去了九寨沟、峨眉山许愿、西安、壶口瀑布、延安。苏月送给张杰一本日记。苏月考上哈尔滨读研，两人表白在一起。异地两年，吵架增多，冷战拉长，删微信→偷看QQ空间→删QQ→删手机号，默认分手。十五年后张杰成家立业，偶尔想起她，仍有遗憾。",
            "genre": "现实主义青春文学·爱情与成长·遗憾但释然",
            "num_chapters": 43,
            "word_number": 3000,
            "filepath": "",
            "chapter_num": "1",
            "user_guidance": "这是一部以村上春树《挪威的森林》为文字底色、路遥《平凡的世界》为质感肌理的长篇现实主义青春小说。采用分层融合风格体系：第一层（底色60%）村上春树——克制的深情、短句呼吸感、感官精确、意象系统、潜台词对话；第二层（质感25%）路遥——'不评价只呈现'的细节哲学、经济现实的重量、家庭的暗流、中国校园特有感官细节、细节铺垫的耐心，路遥在生活质感和叙事深度上与村上并重；第三层（刀锋5%）太宰治《人间失格》——仅在关键情感高潮处使用自我解剖和温柔绝望；第四层（年代标记5%）八月长安——用2011至2026年具体时代事件标记时间坐标（IG夺冠、新冠疫情、ChatGPT等），霍达的信物意象贯穿全书；保留5%自由发挥空间。叙事采用第一人称回顾视角（张杰），以十五年后的目光回望大学岁月和那段刻骨铭心的异地恋。故事分四部：第一部考研准备期（2014-2015），穿插大一到大三回忆，考研教室最后三个人、奶黄包、螺蛳粉、考研兔子、猫屋咖啡'猫南北/大汪'、迎新晚会视频、苏月写的那封信；第二部成都·重逢与表白（2015-2016），张杰考上成都读研、苏月落榜独自复习一年、苏月来成都+九寨沟+峨眉山许愿+西安+壶口瀑布+延安、苏月送出日记本、表白；第三部哈尔滨·异地与消磨（2016-2018），异地两年、吵架频率增加冷战时间拉长、删微信→偷看QQ空间→删QQ→删手机号、默认分开；第四部余生·回望与释然（2018至今），码农当牛马、买房买车结婚生子、消费记录是唯一物证、日常闪回（奶黄包/螺蛳粉/迎新晚会视频/筷子停顿/搬家时翻出日记本）。核心情感：遗憾但释然。",
            "characters_involved": "张杰, 苏月, 陈北, 林文, 赵航",
            "key_items": "奶黄包, 螺蛳粉（从嗤之以鼻到自己网购）, 考研兔子, 白色信封（那封信）, 深蓝色笔记本（日记本）, 消费记录, 迎新晚会视频, 黄色风衣",
            "scene_location": "南方某大学物理学院考研教室(学院1楼角落的教室,空旷,能坐两百人只剩三人), 学校后门螺蛳粉店, 猫屋咖啡, 食堂二楼, 操场跑道(傍晚六点夕阳), 图书馆四楼自习室(窗外芒果树), 成都(火锅串串担担面), 九寨沟(碧蓝海子), 峨眉山金顶(烧香许愿), 西安(古城墙), 壶口瀑布, 延安(延河边月光), 哈尔滨(零下二十八度), 哈尔滨火车站出站口(她在雪地里等), 成都某互联网公司(加班996), 成都的家(搬家时翻出日记本)",
